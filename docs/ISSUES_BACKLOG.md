...
- [x] `week-6` `type:feature` `p2` Log / recent-activity section — small dated list (3-5 entries) of recent shipped features, experiments, or writing, styled as a minimal mono-type ticker; mirrors alche.studio's dated News list -- component built in PR #66 but never rendered on the page; wired in and checked off in PR #73
